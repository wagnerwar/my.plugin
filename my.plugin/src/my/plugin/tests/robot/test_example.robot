...
#
#  $ bin/test -s my.plugin -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src my.plugin.testing.MY_PLUGIN_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/my/plugin/tests/robot/test_example.robot
#
